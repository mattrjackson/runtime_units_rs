...
quantity! {
    ...
    units {
        ...
        /// Amount of ideal gas contained in a volume of cubic mol at standard temperature (O°C) and pressure (1 bar)
        @standard_cubic_mol: 1_E5 * prefix!(none) / 8.314_462_618 / 273.15; "m³(STP)",
            "standard cubic mol", "standard cubic mols";
        ...
        /// Amount of ideal gas contained in a volume of cubic centimol at standard temperature (O°C) and pressure (1 bar)
        @standard_centimol: 1_E5 * prefix!(micro) / 8.314_462_618 / 273.15; "cm³(STP)",
            "standard cubic centimol", "standard cubic centimols";
